<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<dynamic>" %>
    ...
    <body>
        ...
        <div class="book" style="margin: 0 auto;">
            <style>
                .ov{overflow:hidden}
                .a1{width:100%;padding-top:60pt; /*background:url(../images/img.jpg) no-repeat;*/}
        ...
        margin-bottom: 3pt;}
                ...
                .ul-b{width:800px; margin-left:36px;margin-top:70pt;overflow:hidden;}
                ...
                foreach (var stu in list)
                {
                    ...
                    <div class="page w3cbbs">
                        ...
                        <div class="ov" style="padding-top:0pt">
                                <ul class="ul-c fr" style="margin-top:130pt; margin-right:50pt">
