...
namespace IYun.Models
{
    ...
    public partial class VW_Power
    {
        ...
        public Nullable<int> y_vaild { get; set; }
        public Nullable<int> y_level { get; set; }
        public Nullable<int> y_sort { get; set; }
        public string y_url { get; set; }
        public Nullable<int> y_parentID { get; set; }
    }
}
