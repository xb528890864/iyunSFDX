(function(c) {
    c.extend(c.expr[":"], { nic: function(a, c, d, b) { return!(0 <= (a.textContent || a.innerText || "").toLowerCase().indexOf((d[3] || "").toLowerCase())) } });
    c.fn.editableSelect = function(a) {
        ...
        ({
            ...
            initializeList: function() {
                ...
                b.mouseenter(function() { b.find("li.selected").removeClass("selected") })
            },
